...
- Fix factory() unsafe deserialization — validate _type against known packet allowlist before globals() lookup [`83cf74a`](https://github.com/craigerl/aprsd/commit/83cf74a)
