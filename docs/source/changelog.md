...
## [Unreleased](https://github.com/craigerl/aprsd/compare/5.0.1...HEAD)

### Refactoring

- refactor: self-registering packet registry in packets/core [`72541bf`](https://github.com/craigerl/aprsd/commit/72541bf)
- refactor: compose Position value object into GPSPacket [`f30f764`](https://github.com/craigerl/aprsd/commit/f30f764)
- Non-breaking: GPS packet types still accept the legacy flat position kwargs (latitude=, longitude=, ...) and flat attribute reads (packet.latitude); the legacy form is deprecated and will be removed in a future release — use position=Position(...) [`f30f764`](https://github.com/craigerl/aprsd/commit/f30f764)

## [5.0.1](https://github.com/craigerl/aprsd/compare/5.0.0...5.0.1)

### Bug Fixes

- feat: send piggyback ACK (Reply-Ack) in outbound MessagePackets per APRS spec replyacks.txt [`09e66e0`](https://github.com/craigerl/aprsd/commit/09e66e0)

- Add configurable `enable_piggyback_ack_packets` setting, disabled by default [`c22e12a`](https://github.com/craigerl/aprsd/commit/c22e12a)

- Keep standalone ACKs immediate when piggybacking is disabled [`084c3c9`](https://github.com/craigerl/aprsd/commit/084c3c9)
...
- Fix WeatherPacket.key returning None when both timestamps absent — add fallback return of from_call [`1c0b261`](https://github.com/craigerl/aprsd/commit/1c0b261)

- Fix APRSDStats.stats() typo 'loging_queue' → 'logging_queue' [`56839e4`](https://github.com/craigerl/aprsd/commit/56839e4)

- Fix APRSDThreadList.pause_all/unpause_all: pass lock arg to @wrapt.synchronized [`bd6f74e`](https://github.com/craigerl/aprsd/commit/bd6f74e)

- Write object stores atomically using temporary files, fsync, and os.replace [`95f2eb0`](https://github.com/craigerl/aprsd/commit/95f2eb0d94c499fd7b268a121df5fb93de119c64)
...
- Fix StatsStore.__init__ — initialise self.data = {} to prevent AttributeError on save() before add() [`7828c38`](https://github.com/craigerl/aprsd/commit/7828c38)
...
- Remove `shell=True` from fortune plugin subprocess call [`0f0a19c`](https://github.com/craigerl/aprsd/commit/0f0a19c)

- Change MAX_PACKET_ID from 9999 to 999 to match standard APRS-I range [`e811a4e`](https://github.com/craigerl/aprsd/commit/e811a4e)

- Add atomic PacketCounter.next_value() to prevent duplicate msgNo [`f20724f`](https://github.com/craigerl/aprsd/commit/f20724f)

- Add explicit timeout to outbound HTTP calls in plugin_utils [`e572e43`](https://github.com/craigerl/aprsd/commit/e572e43)

- Stop double-counting ack, reject and piggyback-ack packets in stats [`68300c2`](https://github.com/craigerl/aprsd/commit/68300c2)

- Guard piggyback ack against overwriting plugin-set ackMsgNo [`7d50c76`](https://github.com/craigerl/aprsd/commit/7d50c76)

- Handle missing fortune binary without raising [`74288f6`](https://github.com/craigerl/aprsd/commit/74288f6)

- Guard daemon threads against unhandled loop() exceptions [`7f6bcef`](https://github.com/craigerl/aprsd/commit/7f6bcef)

- Run TX throttle sleep outside the global send lock [`a91f566`](https://github.com/craigerl/aprsd/commit/a91f566)

- Return parsed JSON from get_weather_gov_metar [`8c45c76`](https://github.com/craigerl/aprsd/commit/8c45c76)

- Add timeout to APRS registry HTTP POST [`321030b`](https://github.com/craigerl/aprsd/commit/321030b)

- Stop beacon thread on non-numeric lat/long config [`80896e4`](https://github.com/craigerl/aprsd/commit/80896e4)

- Guard KeepAliveThread against missing stats producers [`fc91281`](https://github.com/craigerl/aprsd/commit/fc91281)

- Read TX throttle rate from CONF lazily [`02c11cb`](https://github.com/craigerl/aprsd/commit/02c11cb)

- Replace assert-based plugin validation with explicit raises [`4d8c1d6`](https://github.com/craigerl/aprsd/commit/4d8c1d6)

- Replace RingBuffer __class__ swap with a bounded deque [`c01d83c`](https://github.com/craigerl/aprsd/commit/c01d83c)

- Register APRSDClient as keepalive producer after init [`e25a7c6`](https://github.com/craigerl/aprsd/commit/e25a7c6)

### Tests

- Call `_attach_piggyback_ack` on a real thread instance [`39be5d4`](https://github.com/craigerl/aprsd/commit/39be5d4)

### CI

- Restrict master-build workflow to master branch and tags only [`3261883`](https://github.com/craigerl/aprsd/commit/3261883)
...
- Added SerialKISSDriver [`#204`](https://github.com/craigerl/aprsd/pull/204)
- Added new passcode command [`9098275`](https://github.com/craigerl/aprsd/commit/909827545c351da9f0d15c1bf0aeb475d930e741)
- updated README [`8f6f8cd`](https://github.com/craigerl/aprsd/commit/8f6f8cd4065449cd306d364a551724ce98e9fb89)
- Added @trace.no_trace [`d28ed86`](https://github.com/craigerl/aprsd/commit/d28ed86f31a974bf7b8ef3b6a9f3f5839d74d9cb)
- Move some class vars out of __init__ [`6bd0f50`](https://github.com/craigerl/aprsd/commit/6bd0f50dc01323c0bed16c485ddb712dc19303d4)
- Got the serial KISS driver working [`50022e1`](https://github.com/craigerl/aprsd/commit/50022e1e9eb863f5b53c4d8067baff9a94e631ee)
- fixed tox failures [`c34a821`](https://github.com/craigerl/aprsd/commit/c34a82108bc00fb540385ccbb185d5ef2f862479)
- fixed some formatting issues with filter.py [`e821fbf`](https://github.com/craigerl/aprsd/commit/e821fbf53ed539ea8bd9e28f101e5b816c2a7ce6)
- Ensure should quit returns a value [`ebbde0c`](https://github.com/craigerl/aprsd/commit/ebbde0ccded566a6b0c8118962d5f7142d7b290c)
- ensure join has timeout [`2b2dbb1`](https://github.com/craigerl/aprsd/commit/2b2dbb114bd9f4ead57afa006833543f80d8b06a)
- Added unit tests [`d0dfaa4`](https://github.com/craigerl/aprsd/commit/d0dfaa42e6c80099e8b7f38ce80a2c4be55a8551)
- remove js from codeql [`37f8c62`](https://github.com/craigerl/aprsd/commit/37f8c622652b6dc3ef94ced1f116f30713c5f093)
- upgrade codeql to v4 [`23ad059`](https://github.com/craigerl/aprsd/commit/23ad0597076f312d2e8c8caaca5507d822b8d921)
- Reworked README and documentation [`5ece2a1`](https://github.com/craigerl/aprsd/commit/5ece2a10ef7eec5c073c1de4a666dcdba8def7eb)
- Added rich cli screenshot to README [`eaadf9a`](https://github.com/craigerl/aprsd/commit/eaadf9a0adf4a2005f0aee8dae80f293c3b01c21)
- Added Documentation link to pyproject.toml [`0ef1316`](https://github.com/craigerl/aprsd/commit/0ef131678f13771b4d4961fab4a345e0e73e0257)
- Reworked listen command log output [`6112628`](https://github.com/craigerl/aprsd/commit/61126289dfee04460cbede4d00a71af1c3abc350)
- reworked Documentation [`eb0818a`](https://github.com/craigerl/aprsd/commit/eb0818af65f40ee8b7be18a7923166f8ac52db7d)
- Try embedded asciinema video in readme [`26d7719`](https://github.com/craigerl/aprsd/commit/26d771915f82bdf9b24ef230dcd330d0d9e825c3)
...
- update for release [`cdb2ce9`](https://github.com/craigerl/aprsd/commit/cdb2ce910ab167cf333e6f0cd75e0f021f088a09)
